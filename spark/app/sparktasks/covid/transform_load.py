...
class TransformLoad:
    ...
    def get_usa_table_query(self):
        ...
        if row:
            ...
            return """(SELECT * FROM {} WHERE  STR_TO_DATE(submission_date,'%m/%d/%Y') > '{}') foo"""\
                .format(self.config.covid_usa_raw, date_time)
    ...
    def transform_load_usa_data(self):
        try:
            ...
            usa_data_df = new_df1.select("date_id", "state_id", "submit_date", "new_deaths", "new_cases",
